...
class ConfigurationManager:
    ...
    def get_prepare_callback_config(self) -> PrepareCallbacksConfig:
        ...
        create_directories([                                #creating the directories
            Path(model_ckpt_dir),
            Path(config.tensorboard_root_log_dir)
        ])

        prepare_callback_config = PrepareCallbacksConfig(     #calling the directories
            root_dir=Path(config.root_dir),
    ...
    def get_training_config(self) -> TrainingConfig:
        ...
        params = self.params
        training_data = os.path.join(self.config.data_ingestion.unzip_dir, "chicken_small_dataset")
        create_directories([
    ...
    def get_validation_config(self) -> EvaluationConfig:
        ...
        training_data=Path("artifacts/data_ingestion/chicken_small_dataset"),
